...
public class MaxClosePrice {
	...
	public static void main(String[] args) throws Exception {
		...
		//Writable is used when data is used for transferring. Serialization is neccessary to trannsfer Default serialization 
		//provided by java is not compact enough and used reference to class name 
